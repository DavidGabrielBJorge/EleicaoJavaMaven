package br.edu.iftm.upt.justificativa.pagination;
...
public class PageWrapper<T> {
	...
	private int maximoPaginasMostrar = 9;
	private int inicio;
	private int fim;
	...
	private String removeEmptyQueryParams(String queryString) {
		...
		if (!queryString.isBlank()) {
			for (String parameter : queryString.split("&")) {
				if (parameter.indexOf('=') != parameter.length() - 1) { // achou o = antes da ultima posicao, ou seja,
																		// tem
																		// valor
