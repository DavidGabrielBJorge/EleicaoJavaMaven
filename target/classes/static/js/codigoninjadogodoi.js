window.addEventListener("load", function() {
	...
	console.log("carregou o codigoninja");
    ...
    function prepararConfirmacoesEnvioAJAX() {
    	console.log("entrou na funcao prepararConfirmacoesEnvioAJAX");
    	let botoesConfirmacao = document.querySelectorAll(".confirmacaoenvioajax");
    	botoesConfirmacao.forEach(function(botao) {
    		let formPai = botao.parentNode;
    		formPai.addEventListener("submit", function(evento) {
    			let mensagem = "Você esqueceu de definir a mensagem a ser exibida aqui...";   			
